...
- [Modulation coverage, training data, and synthesis](#modulation-coverage-training-data-and-synthesis)
  ...
  - [Synthetic orders (17) — bandwidths verified at generation](#synthetic-orders-17--bandwidths-verified-at-generation)
...
#### Synthetic orders (17) — bandwidths verified at generation
...
| **Synthetic** (this repo) | `datasets/synthetic/synthetic.npz` | NBFM, squelch tones, aviation AM, WBFM, PSK, protocol 4FSK/P25, packet radio; generated locally |
...
See the [Synthetic orders](#synthetic-orders-17--bandwidths-verified-at-generation) tables
...
shape `(2, 1024)` float32. Default run: 1000 chunks × 26 SNR levels × **17** classes ≈
**442k** samples. Bandwidth and 4FSK structure checks use clean reference chunks before
noisy data is kept.
...
| `rmv dataset generate-synthetic` | Generate synthetic FM/AM/PSK/4FSK/squelch/packet IQ (17 modes by default) |
...
- **Synthetic** — seventeen orders (NBFM, aviation AM, WBFM, PSK, protocol 4FSK, squelch
  tones, P25, packet radio) via `rmv dataset generate-synthetic`; see
  [Synthetic orders (17)](#synthetic-orders-17--bandwidths-verified-at-generation).
