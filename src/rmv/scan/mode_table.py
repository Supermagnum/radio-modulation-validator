...
MODE_TABLE: dict[str, ModeSpec] = {
    ...
    "P25": ModeSpec(
        ...
        "synthetic",
        protocol_only=True,
        note="P25 Phase 1 C4FM (TIA-102.BAAA); framing not verified.",
    ),
    "NFM_CTCSS": ModeSpec(
        "NFM_CTCSS",
        "FM",
        "NFM_CTCSS",
        "synthetic",
        note="12.5 kHz NFM with CTCSS subaudible tone.",
    ),
    "NFM_DCS": ModeSpec(
        "NFM_DCS",
        "FM",
        "NFM_DCS",
        "synthetic",
        note="12.5 kHz NFM with DCS digital squelch (134.4 bit/s).",
    ),
    "BELL202": ModeSpec(
        "BELL202",
        "FSK",
        "BELL202",
        "synthetic",
        note="Bell 202 AFSK physical layer (1200/2200 Hz, 1200 baud).",
    ),
    "G3RUH": ModeSpec(
        "G3RUH",
        "FSK",
        "G3RUH",
        "synthetic",
        note="G3RUH 9600 baud direct FSK (packet backbone / VARA FM).",
    ),
    "VARA FM": ModeSpec(
        "VARA FM",
        "FSK",
        "G3RUH",
        "synthetic",
        note="VARA FM uses G3RUH-style 9600 baud FSK at physical layer.",
    ),
    ...
    "IL2P": ModeSpec(
        ...
        "BELL202",
        "synthetic",
        note="Protocol framing over Bell 202 AFSK; physical layer only.",
    ),
    "FX.25": ModeSpec(
        "FX.25",
        "FSK",
    ...
    "APRS": ModeSpec(
        ...
        "BELL202",
        "synthetic",
        note="APRS uses Bell 202 AFSK physical layer only.",
    ),
